                  ...
                  >
                    ...
                    <td className="p-4 text-right whitespace-nowrap">
                      <Link
                        href={`/blogs/${b.slug}`}
                        target="_blank"
                        className="mr-3 text-sm font-semibold text-muted hover:text-accent transition-colors"
                      >
                        Xem
                      </Link>
                      <Link
                        href={`/admin/blogs/${b._id}`}
                        className="mr-3 text-sm font-semibold text-text hover:text-accent transition-colors"
                      >
                        Sửa
                      </Link>
                      <button
