...
export const metadata: Metadata = {
  title: "Liên Hệ | From the Stress",
  description:
    "Liên hệ với From the Stress (F.T.S) — thương hiệu streetwear Gen Stress. Chúng tôi luôn sẵn sàng hỗ trợ bạn.",
};
      ...
      <section className="contact-hero">
        ...
        <div className="contact-hero__content">
          ...
          <p className="contact-hero__subtitle">
            Contact us today for refined service designed for our
            <br />
            discerning FTS fashion community.
          </p>
      ...
      <section className="contact-info-section">
        <div className="contact-info-grid">
          <div className="contact-info-card">
            ...
            <p className="contact-info-card__label">Email Address</p>
          </div>
          ...
          <div className="contact-info-card">
            ...
            <p className="contact-info-card__label">Phone Number</p>
          </div>
          ...
          <div className="contact-info-card">
            ...
            <p className="contact-info-card__value">Hồ Chí Minh, Việt Nam</p>
