  ...
  return (
    <div className="order-page">
      <div className="order-page__inner">
        <h1 className="order-page__title">Đơn hàng của tôi</h1>
        <p className="order-page__subtitle">
          Trạng thái và lịch sử các đơn hàng bạn đã mua
        </p>
        ...
        {error ? (
          ...
          <div className="order-empty">
            ...
            <h2 className="order-empty__title">Bạn chưa có đơn hàng nào</h2>
            <p className="order-empty__text">
              Hãy khám phá thêm các sản phẩm mới nhất của chúng tôi!
            </p>
