  ...
  return (
    <div className="profile-page">
      <div className="profile-page__header">
        <h1 className="profile-page__title">{t('myAccount')}</h1>
      ...
      <div className="profile-page__layout">
        ...
        <div className="profile-card profile-card--sidebar">
          ...
          <div className="profile-badge">{t('memberSince', { date: joinDate })}</div>
        ...
        <div className="profile-content">
          <div className="profile-card">
            <h3 className="profile-card__title">{t('contactInfo')}</h3>
          ...
          <div className="profile-card">
            <h3 className="profile-card__title">{t('referFriend')}</h3>
